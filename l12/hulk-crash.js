...
if (process.argv.length < 7){console.log(`node black-chip target time rate thread proxy.txt`); process.exit();}
const headers = {};
...
headers["cookie"] = "cf_clearance=" + randstr(43) + "-" + randno(10) + "-0.0.1-" + randstr(8) + "." + randstr(8) + "." + randstr(8) + "-"+ randno(3) + "." + randno(10);
